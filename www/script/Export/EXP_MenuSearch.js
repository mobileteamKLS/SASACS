    ...
    //row +="<div class='panel-group' id='accordion' role='tablist' aria-multiselectable='true'>";
                $.each(obj, function (i, d) {
                  ...
                  var _AWBID = '"' + d.AWBID + '"';
                    ...
                    row +="<button class='btn-arrow' data-toggle='collapse' data-parent='#accordion' href='#collapse" + i + "' aria-expanded='true' aria-controls='collapse" + i + "' style='border: none;background-color: white;'>";
                    row +="<i class='more-less zmdi zmdi-chevron-right' id='down-arrow' style='float: none !important;margin-right: 0px !important;font-size: 30px; color:#03b6ae;background-color: white;margin-left: 15px;'></i>";
                    row +="</button>";
                    row +="</div>";
                  }
            ...
            if (obj[0].ERRORMSG == undefined) {
              ...
              if(MenuTitle == "View SB Details"){
                ...
                if(obj[0].Status == "Completed"){
                  $("#DocStatus").text(obj[0].Status).css( "color", "#03b6ae" );
...
uploadClick = function(){
  ...
  {
    if(($("#fileCSD").val()) == "" && ($("#fileAWB").val()) == "" && ($("#fileList").val()== "") ){
      $("body").mLoading('hide');
    errmsg = "Alert</br>";
          ...
          $.each(obj, function (i, d) {
            ...
            path = '' + d.FilePath + '';
                ...
                $("#tblTrackInfo").show();
                    ...
                    //  }else{
                      row += "<td class='text-left' style='color: black;font-size:12px;word-break: break-all;padding-bottom: 5px;' style='text-transform:none !important' ><a id = 'myFile' href='#'  onclick='goToDocument()'>" + "<u>"+ d.DocumentName + "</u>" + ".pdf</a></td>";
                    // }
                    ...
                    if(d.DocAcceptance == "True"  && status == "Completed"){
                      ...
                      $("#submitButton").css({ "background-color": "lightgrey", "color": "white !important" , "border": "1 px solid grey !important"});
                        ...
                        $("#submitButton").css({ "background-color": "#03b6ae", "color": "white" , "border-color": "#03b6ae"});
                      }
