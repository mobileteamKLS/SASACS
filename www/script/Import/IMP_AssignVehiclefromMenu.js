...
$(function () {
  $("#CTODot").css('background-color', '#03b6ae');
    ...
    $("#AlloDot").css('border', '1px solid #03b6ae');
             ...
             console.log(obj);
              if (obj.length > 0) {
                if (obj[0].ERRORMSG == undefined) {
                 ...
                 window.location.href = "IMP_FinalVTListfromMenu.html";
