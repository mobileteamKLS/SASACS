...
ImportListingPageDetails = function (OperationType, AirlinePrefix, AwbNumber, HawbNumber, IGMNo, IGMYear, CreatedByUserId, OrganizationBranchId, OrganizationId) {
          ...
          if (obj.length > 0) {
            if (obj[0].ERRORMSG == undefined) {
              ...
              if(obj[0].TspStatus == "Approved"){
                ...
                TspStatus = "Approved";
                $("#TSPStatus").text((obj[0].TSPPayableAmount).toFixed(2)).css( "color", "#03b6ae" );
  ...
  getBoEStatus = function(){
    ...
    $.ajax({
    type: 'POST',
    url: ACSServiceURL + "/ACS_IMP_GetBOEDetails",
    data: JSON.stringify({
        "OperationType":1,
    ...
    success: function (response, xhr, textStatus) {
      ...
      var row = "";
       if (obj.length > 0) {
        row += "<table id='tblAirWayBillInfo' width='100%' style='border: lightgrey 1px solid;'>";
         row += "<tr class='table_row'>";
         row += "<td class='spanTD'>BOE Number</td>";
         if( obj[0].BOENumber == "")
         row += "<td class='col2'><span id='spnCGST'></span><img src='img/icon_status_pending.png' style='margin: 0px 5px;height: 20px;width: 20px;'/>Pending</td>";
         else
         row += "<td class='col2' ><span id='spnCGST'></span><img src='img/icon_status_completed.png' style='margin: 0px 5px;height: 20px;width: 20px;'/>"+ obj[0].BOENumber +"</td>";

      
         row += "</tr>";
         row += "<tr class='table_row'>";
         row += "<td class='spanTD'>BOE Pay Ref No</td>";
         if( obj[0].BoEPaymentRefNo == "")
         row += "<td class='col2'><span id='spnCGST'></span><img src='img/icon_status_pending.png' style='margin: 0px 5px;height: 20px;width: 20px;'/>Pending</td>";
         else
         row += "<td class='col2' ><span id='spnCGST'></span><img src='img/icon_status_completed.png' style='margin: 0px 5px;height: 20px;width: 20px;'/>"+ obj[0].BoEPaymentRefNo +"</td>";

        
         row += "<tr class='table_row'>";
         row += "<td class='spanTD'>BOE Status</td>";
         if( obj[0].BOEStatus == "Approved")
         row += "<td class='col2'><span id='spnCGST'></span><img src='img/icon_status_completed.png' style='margin: 0px 5px;height: 20px;width: 20px;'/>"+ obj[0].BOEStatus +"</td>";
         else if( obj[0].BOEStatus == "Pending")
         row += "<td class='col2' ><span id='spnCGST'></span><img src='img/icon_status_pending.png' style='margin: 0px 5px;height: 20px;width: 20px;'/>"+ obj[0].BOEStatus +"</td>";
         else
         row += "<td class='col2' ><span id='spnCGST'></span><img src='img/icon_status_partial.png' style='margin: 0px 5px;height: 20px;width: 20px;'/>"+ obj[0].BOEStatus +"</td>";
         row += "</tr>";
         row += "</table>";
