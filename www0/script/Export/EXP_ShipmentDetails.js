          ...
          if (obj.length > 0) {
            ...
            //   asistatus = obj[0].BoEASIStatus;
             VTStatus = obj[0].VTStatus;
              if(obj[0].ASIStatus == "Completed"){
                $("#SBASIDot").css('background-color', '#20A8D8');
                $("#SBASIDot").css('border', '1px solid #20A8D8');
                ...
                $("#SBASIDot").css('border', '1px solid orange');
                  ...
                  if(obj[0].ASIStatus == "Completed"){
                    $("#SBAsiStatus").text(obj[0].ASIStatus).css( "color", "#20A8D8" );
            ...
            //   }
              ...
              if(obj[0].TSPStatus == "Completed"){
                ...
                TspStatus = "Completed";
                $("#TSPStatus").text((obj[0].TSPAmount).toFixed(2)).css( "color", "#20A8D8" );
