          ...
          if (obj.length > 0) {
            if (obj[0].ERRORMSG == undefined) {
              ...
              if(obj[0].BoEApproved == "Approved"){
                ...
                $("#BoEDot").css('border', '1px solid #20A8D8');
              ...
              if(obj[0].OoCApproved == "Approved"){
                ...
                $("#OoCDot").css('border', '1px solid #20A8D8');
              ...
              if(obj[0].BoEASIStatus == "Pending"){
                ...
                $("#BoEASIDot").css('border', '1px solid #20A8D8');
              ...
              if(obj[0].TspStatus == "Approved"){
                ...
                $("#TSPDot").css('border', '1px solid #20A8D8');
            ...
            if(obj[0].VTStatus == "Approved" || obj[0].VTStatus == "Generated"){
              ...
              $("#VTDot").css('background-color', '#20A8D8');
              $("#VTDot").css('border', '1px solid #20A8D8');
