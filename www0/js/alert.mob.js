...
!function ($) {
	...
	$.confirm=function(){
		...
		if(args.length){
			...
			d =$('<div class="alert_overlay"><div class="alert_msg"><div class="alert_heading"><label class="log_label" style="font-weight: bold;font-size: large;">'+args[0]+'</label></div><div class="alert_content">'+args[1]+'</div><div class="alert_buttons"><button class="alert_btn alert_btn_ok">Close</button><button class="alert_btn alert_btn_cancel">Cancel</button></div></div></div>')
